...
import {Renderer} from "../contracts/Renderer.sol";
...
contract QA is Script {
    ...
    function run(uint256 start, uint256 stop) public {
        ...
        for (uint256 i = start; i < stop; i++) {
            ...
            args[2] = string.concat(subCommandInputs[0], subCommandInputs[1], subCommandInputs[2], subCommandInputs[3]);
            vm.ffi(args);
            ...
            args[2] = string.concat(subCommandInputs[0], subCommandInputs[1], subCommandInputs[2]);
