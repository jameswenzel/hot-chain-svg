...
library SVG {
    ...
    function svg(string memory _props, string memory _children) internal pure returns (string memory) {
        return el("svg", string.concat(prop("xmlns", "http://www.w3.org/2000/svg"), " ", _props), _children);
    }
    ...
    function tspan(string memory _props, string memory _children) internal pure returns (string memory) {
